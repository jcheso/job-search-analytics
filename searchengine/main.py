...
def get_analytics(job, location):
      ...
      average_pay, most_frequent_location, top_companies, currency, top_words = job_analytics.get_job_analytics(jobs, job, location)

      return(average_pay, most_frequent_location, top_companies, currency, top_words)
